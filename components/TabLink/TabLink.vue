<template>
  <div
    class="tabs tw-mt-9 tw-flex tw-items-center tw-justify-start tw-gap-5 tw-flex-wrap"
  >
    <NuxtLink
      :to="localePath(tab?.link ?? '')"
      class="word tab-item tw-no-underline"
    >
      <span
...
<style scoped src="./tabLink.scss"></style>
